...
로그인 후 마이페이지에 접속하면 위와 같이 자신의 캐릭터를 관리할 수 있습니다.
...
공지사항을 확인하지 못하는 경우가 없도록, 인디케이터를 추가하였습니다.
